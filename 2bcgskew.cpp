...
2bcgskew::2bcgskew(unsigned _localPredictorSize,
...
void
2bcgskew::updateGlobalHistTaken()
{
...
void
2bcgskew::updateGlobalHistNotTaken()
{
...
unsigned
2bcgskew::computeLocalIndex(Addr branch_addr, unsigned positionInFetchGroup)
{
...
unsigned
2bcgskew::computeChoiceIndex(Addr branch_addr, unsigned positionInFetchGroup)
{
...
unsigned
2bcgskew::computeGlobalIndex0(Addr branch_addr, unsigned positionInFetchGroup)
{
...
unsigned
2bcgskew::computeGlobalIndex1(Addr branch_addr, unsigned positionInFetchGroup)
{
...
void
2bcgskew::BTBUpdate(Addr &branch_addr, void * &bp_history)
{
...
bool
2bcgskew::gSkewPredict(Addr &branch_addr, void * &bp_history, unsigned positionInFetchGroup, bool onDemand, bool &choice, BPHistory *history)
{
...
bool
2bcgskew::lookup(Addr &branch_addr, void * &bp_history, unsigned positionInFetchGroup, bool onDemand, bool &choice, bool onlyLP)
{
    unsigned local_predictor_idx;
...
void
2bcgskew::uncondBr(void * &bp_history)
{
    // Create BPHistory and pass it back to be recorded.
    BPHistory *history = new BPHistory;
    history->globalHistory = globalHistory;
...
void
2bcgskew::onDemandBr(Addr &branch_addr, void * &bp_history, unsigned positionInFetchGroup)
{
  // Create BPHistory and pass it back to be recorded.
  BPHistory *history = new BPHistory;
  history->globalHistory = globalHistory;
...
void
2bcgskew::update(Addr &branch_addr, bool taken, void *bp_history,
                     bool squashed)
{
...
void
2bcgskew::histUpdate(Addr &branch_addr, bool taken, void *bp_history,
                     bool squashed)
{
    if (bp_history) {
       BPHistory *history = static_cast<BPHistory *>(bp_history);
...
void
2bcgskew::histGarbageCollect(void *bp_history)
{
    if (bp_history) {
       BPHistory *history = static_cast<BPHistory *>(bp_history);
       // We're done with this history, now delete it.
...
void
2bcgskew::squash(void *bp_history)
{
    BPHistory *history = static_cast<BPHistory *>(bp_history);
